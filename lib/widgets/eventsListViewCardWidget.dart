...
import 'package:graduate_plus_app/views/eventFinalScreenView.dart';
...
class EventsListViewCardWidgets extends StatelessWidget {
  final bool hasLogo;
  final String postedBy;
  final String postedDate;
  final String nextScreen;
  final Future<List<EventsModel>> events;
  const EventsListViewCardWidgets({
    super.key,
    ...
    return FutureBuilder<List<EventsModel>>(
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemCount: events.length, // Number of items
              ...
              onTap: () {
                nextScreen == "detail"
                    ? Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) => Graduateeventdetailscreenview(
                              event: events[index],
                            ),
                      ),
                    )
                    ...
                    ? Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) => EventsFinalDetailScreenView(
                              event: events[index],
                            ),
                      ),
                    )
